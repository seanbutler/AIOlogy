...
def main():
    ...
    for epoch in range(train_config['epochs']):
        ...
        test_accuracy = calculate_accuracy(my_Net, test_loader)
        val_accuracy = calculate_accuracy(my_Net, val_loader)
    ...
    plot_training_curves(loss_history, accuracy_history, validation_accuracy_history, config, my_Net, test_loader)
